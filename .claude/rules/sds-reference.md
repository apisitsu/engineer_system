---
paths:
  - "apps/ENG-Backend/api/engineer/mtc/**/*sds*"
  - "apps/ENG-Backend/api/engineer/mtc/**/*Sds*"
  - "apps/ENG-Frontend/src/components/engineer/mtc_eng/sds/**"
---

# SDS v2 — Setup Data Sheet API Reference
...
```json
{
  ...
  "item_no": "394137",
  "part_type": "BALL",
  "part_info": { "class1": "C39", "class1_name": "...", "sub_class": "...", "part_type": "..." },
  "parts_no": "3L117548-T",
  "dwg_rev": "A",
  "material": {
  ...
  "dimension": { "control_no": "C39-04137", "ball_dia": "42.029", "width": "9.987", "in_dia": "34.999" },
  "process_info": [{ "seq_no": "10", "process_seqno": "1", "process_code": "GR01", "wc": "KS03A", "ct": "120", "st": "60", "batch_size": "100", "process_name": "...", "process_eng": "..." }],
  "process_plan": [{ "process_plan_no": "PP-001", "seq_no": "10", "rev": "A", "process_code": "GR01", "tool_dwg_no": "T-001", "tool_name": "...", "process_name": "...", "process_eng": "..." }],
  "production": { "control_no": "C39-04137", "model": "...", "customer": "...", "type": "...", "packing": "...", "approval_type": "...", "cust_dwg_no": "...", "sdwg_no": "...", "update_date": "..." }
}
```
...
### `material` — 2-step lookup
1. **BOM Lookup** (`lpb.eng_bom`): `parent_cn = CN` → ได้ `child_cn` (PM part เช่น `PM1-04844`)
2. **Material Code Lookup** (`lpb.eng_mcode`): `mate_class_code4 = LEFT(PM.parts_no, 4)` → ได้ material info

| Field | Source |
|-------|--------|
| `material` | `eng_mcode.as400name` |
| `mate_code` | `eng_mcode.mate_code` |
| `procument_spec` | `eng_mcode.procument_spec` |
| `raw_control_no` | `eng_bom.child_cn` |
| `raw_parts_no` | `lpb.eng_item.parts_no` |
