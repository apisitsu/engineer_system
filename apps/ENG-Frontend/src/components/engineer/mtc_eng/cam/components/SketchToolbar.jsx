...
const TOOLS = [
  ...
  { value: 'point', label: 'Point', Icon: PointIcon, hint: 'Click on the plane to add points · snaps to vertices, curve rims, circle quadrants (the axis high points) and where two curves cross' },
  { value: 'line', label: 'Line', Icon: LineIcon, hint: 'Click to start, click to finish · locks to 0/45/90…°, snaps tangent to circles/arcs, to their quadrants and to curve intersections · Esc cancels' },
