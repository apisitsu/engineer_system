...
const CardDetailDrawer = () => {
    ...
    const handleEditLinkSave = async (linkId) => {
        ...
        if (!urlPattern.test(editLinkUrl.trim())) {
            Swal.fire('Error', 'Invalid URL format', 'error');
            return;
        }
                                                    ...
                                                    <div key={att.id} style={{
                                                        ...
                                                        <div style={{ flex: 1, minWidth: 0 }}>
                                                            <a href={fileUrl} target="_blank" rel="noreferrer"
                                                                style={{ fontSize: 13, display: 'block', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', color: theme.colors.primary, textDecoration: 'none' }}>
                                                                {att.file_name}
                                                            </a>
                                                            {att.file_size && (
                                                ...
                                                return (
                                                    <div key={att.id} style={{
                                                        ...
                                                        {isEditing ? (
                                                            ...
                                                            <>
                                                                <a href={linkData?.url || att.file_path} target="_blank" rel="noreferrer"
                                                                    style={{ flex: 1, color: theme.colors.primary, fontSize: 13, textDecoration: 'none', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}
                                                                >
                                                                    {att.file_name || linkData?.url || att.file_path}
                                                                </a>
                                                                {!isReadOnly && (
                                                                    <Space size={4}>
                                                ...
                                                {showLinkAttach && (
                                                    <div style={{
                                                        ...
                                                        <Button
                                                            ...
                                                            onClick={async () => {
                                                                await addLinkAttachment(card.id, linkUrl.trim(), linkName.trim());
