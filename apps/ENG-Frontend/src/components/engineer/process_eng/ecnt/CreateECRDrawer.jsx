...
import { Form, Input, Checkbox, Spin, Button, Row, Col, DatePicker, Space, Upload, Radio, Divider, Card, Drawer } from "antd";
...
export default function CreateECRDrawer({ open, onClose, onSuccess }) {
    ...
    const onSubmit = async () => {
        try {
            ...
            // Using ISO 8601 formatting for dates
            ...
            const [
                ...
                getFileBase64(values.upload_setup_before),
                getFileBase64(values.upload_setup_after),
                getFileBase64(values.upload_cutting_before),
                getFileBase64(values.upload_cutting_after)
            ]);
            ...
            const payload = {
                ...
                change: undefined, // cleanup
                process_status: 'Pending Dept Mgr' // Mock status progression
            };
    ...
    return (
        <Drawer
            title={<span style={{ color: theme.colors.primary, fontSize: '1.2em' }}>Create New ECR</span>}
            width={800}
            onClose={onClose}
            open={open}
            footer={footer}
            ...
            <Spin tip="Submitting ECR..." size="large" spinning={loading}>
                <Form form={form} layout="vertical" disabled={loading}>
                    <Row gutter={[24, 16]}>
                        ...
                        {/* Condition A: Setup Data Sheet No, Part No, C/N, Cycle Time */}
                        {hasToolProUsage && (
                            <Col span={24}>
                        ...
                        {/* Condition D (New): Setup Data Sheet Before/After + Upload */}
                        {hasToolProUsage && (
                            <Col span={24}>
                        ...
                        {/* Condition E (New): Cutting Program & Condition Before/After + Upload */}
                        {hasToolPro && (
                            <Col span={24}>
