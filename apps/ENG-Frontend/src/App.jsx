...
import GeneralDwgReport from './components/engineer/mtc_eng/general_dwg_req/GeneralDwgReport';
            ...
            <Route element={<ProtectedRoute />}>
              ...
              <Route element={<ProtectedRoute allowedRoles={['AD', 'ENG', 'QA']} />}>
                ...
                <Route element={<MainLayout />}>
                  ...
                  <Route path={MTC_PATHS.GENERAL_DWG_REPORT} element={<GeneralDwgReport />} />
