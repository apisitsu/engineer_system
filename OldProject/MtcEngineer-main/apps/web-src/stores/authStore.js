...
export function isLoggedIn() {
  return localStorage.getItem(key_constance.LOGIN_PASSED) === 'yes' &&
    !!localStorage.getItem(key_constance.ACCESS_TOKEN);
}
...
function saveSession(data, empno) {
  ...
  localStorage.setItem(key_constance.ACCESS_TOKEN,  data.accessToken);
  localStorage.setItem(key_constance.REFRESH_TOKEN, data.refreshToken || '');
