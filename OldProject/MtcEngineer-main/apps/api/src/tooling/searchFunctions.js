...
// h is always identity in DB context — rows are keyed by original Excel column names (via SQL aliases)
// Each search function receives `h` as parameter; pass `name => name` from caller.
